          ...
          children: <Widget>[
            ClipPath(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: ComingAppTheme.nearlyDarkBlue.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      ComingAppTheme.nearlyDarkBlue.withOpacity(0.2),
                      ComingAppTheme.nearlyDarkBlue.withOpacity(0.5)
                    ],
            ...
            ClipPath(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    colors: [
                      ComingAppTheme.nearlyDarkBlue.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: ScaleTransition(
                ...
                child: Container(
                  ...
                  height: 2,
                  decoration: BoxDecoration(
                    color: ComingAppTheme.white.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: Transform(
                ...
                child: Container(
                  ...
                  height: 4,
                  decoration: BoxDecoration(
                    color: ComingAppTheme.white.withOpacity(
            ...
            Column(
              children: <Widget>[
                AspectRatio(
                  aspectRatio: 1,
                  child: Image.asset("assets/Coming_app/bottle.png"),
                ),
              ],
            )
          ],
